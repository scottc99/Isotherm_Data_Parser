...
class TGApp:
	...
	def runJSON(self):
		...
		sequence2 = self.file.split("/")[-1].split("_")[1]
		sequence3 = self.file.split("/")[-1].split("_")[2]
		sequence4 = self.file.split("/")[-1].split("_")[5]
		sequence5 = self.file.split("/")[-1].split("_")[6].split(".")[0]
